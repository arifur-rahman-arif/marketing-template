    ...
    return (
        <div className="grid w-full bg-secondary-lightCream lg:max-w-[31.13rem] lg:py-6 lg:pr-6">
            <div
                ref={outsideRef}
                id="centre-list"
                className="grid content-start gap-6 overflow-y-auto overflow-x-hidden rounded-large p-5 !pb-1 max-lg:h-full max-lg:max-h-[50rem] sm:grid-cols-2 lg:max-h-[38.1rem] lg:grid-cols-1 lg:py-0 lg:pr-2"
            >

                ...
                <div className="grid grid-cols-[auto_auto_auto] items-center justify-start gap-4">
                    ...
                    <div className="relative z-50 flex w-full items-center justify-start gap-4">
                        ...
                        <div className="relative grid w-full max-w-[13.5rem]" ref={outsideRef}>
                            ...
                            {/* Dropdown menu */}
                            <div
                                className={`absolute ${styles.styles} left-0 top-full z-[3] mt-2 w-full overflow-hidden transition-all duration-1000 ${otherMenuOpen ? 'max-h-[32rem]' : 'max-h-0'}`}
                            >
                                <div className="grid gap-4 rounded-small border border-solid border-gray-20 bg-white px-4 py-2">
                                    {/* Range Slider */}
